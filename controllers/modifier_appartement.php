...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        $idApp = filter_input(INPUT_POST, 'idApp', FILTER_VALIDATE_INT); // Nouveau champ pour la modification
        ...
        // Traitement des images (uniquement pour l'ajout, pas pour la modification)
        if (!$idApp && isset($_FILES['images'])) {
            $uploadedFiles = [];
